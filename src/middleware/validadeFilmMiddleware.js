...
import {getGenreById} from "../repositories/genereRepository.js";

const validationFilm = [
    check('titulo')
    ...
    check('generos').isArray().withMessage('Gêneros não pode ser vazio'),
    check('generos').custom(async (generoIds) => {
    ...
    check('classificacao_etaria')
        .notEmpty().withMessage('Classificação etária é obrigatória'),
...
export { validationFilm, validateFilm, validateFilmId};
